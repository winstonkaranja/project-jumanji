...
class State(TypedDict):
    ...
    ground_key: str
    aerial_key: str
    analyze_result: dict  # to store the LLM response from image analysis
    aerial_result: dict   # to store the result from aerial photo analysis
...
def node_aerial(state: State) -> dict:
    ...
    result = aerial_photo_analysis(llm, state["aerial_key"])
